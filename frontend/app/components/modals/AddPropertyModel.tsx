...
const AddPropertyModal = () => {
  ...
  const submitForm = async () => {
    ...
    if (dataTitle && dataDescription && dataPrice && dataCountry && dataImage) {
      ...
      console.log("error, missing data", dataTitle, dataDescription, dataPrice, dataCountry, dataImage);
    }
  };
  ...
  const content = (
    <>
      {currentStep === 1 ? (
        ...
        <>
          <h2 className="mb-6 text-2xl">Desribe your place</h2>
        ...
        <>
          <p className="mb-6 text-2xl">Details</p>
        ...
        <>
          <p className="mb-6 text-2xl">Location</p>
        ...
        <>
          <p className="mb-6 text-2xl">Image</p>
